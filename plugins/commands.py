...
buttons=InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Source Code", url="https://t.me/Sp_I_dE_x"),
                InlineKeyboardButton("Updates Channel", url="https://t.me/iPopkarnBots")
            ]
        ]
        )
...
async def cb_abt(bot, cb):
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source", url="https://t.me/Sp_I_dE_x"),
            ]
        ]
    )
    )
